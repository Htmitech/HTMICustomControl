...
@interface HTMIValuePickerView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation HTMIValuePickerView
...
- (void)initSubViews
{
    ...
    [self.cancelBtn setTitleColor:[UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1.0] forState:UIControlStateNormal];
