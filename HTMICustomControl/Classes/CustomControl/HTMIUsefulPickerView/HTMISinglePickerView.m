...
@interface HTMISinglePickerView ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation HTMISinglePickerView
...
- (void)dealloc {
//    HTMILogInfo(@"HTMISinglePickerView ===== dealloc");
}
