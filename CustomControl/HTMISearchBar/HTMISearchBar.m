...
@interface HTMISearchBar () 

@property (nonatomic, strong) UIImageView *leftView;

@end

@implementation HTMISearchBar
...
- (void)layoutSubviews{
    ...
    if (@available(iOS 11.0, *)) {
        ...
        searchField.frame = CGRectMake(12, 8, [UIScreen mainScreen].bounds.size.width*0.8, 28);

    } else {
        searchField.frame = CGRectMake(0, 8, [UIScreen mainScreen].bounds.size.width*0.8, 28);
    }
